...
public final class Material {
    ...
    public static final Material TOP_SNOW = Builder.access$000(new Builder(MaterialColor.SNOW).noCollider()).nonSolid().destroyOnPush().replaceable().notAlwaysDestroyable().build();
    ...
    public static final Material WEB = Builder.access$000(new Builder(MaterialColor.WOOL).noCollider()).destroyOnPush().notAlwaysDestroyable().build();
