...
public class Pig extends Mob {
    public static final ResourceLocation TYPE = new ResourceLocation("minecraft", "pig");
    ...
    public Pig(double x, double y, boolean baby) {
        super(TYPE, 10.0f);
        this.baby = baby;
    ...
    protected void onHurt(Entity source, float amount) {
        ...
        if (panicDirection == 0.0f) {
            ...
            SoundSystem.playSound("mob.pig.say" + (MathUtils.random.nextInt(2) + 1));
    ...
    protected void onDeath(Entity source) {
        ...
        SoundSystem.playSound("mob.pig.death");
    }

    /**
     * Applies adult or baby collision scale to the pig.
     */
